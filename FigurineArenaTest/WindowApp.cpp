...
MainWndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	...
	switch (msg)
	{
		case WM_CREATE:
		{
			...
			app = (CWindowApp*)cs->lpCreateParams;
			return 0;
		}
	}
...
CWindowApp::CWindowApp(HINSTANCE hInstance)
{
	mhAppInst = hInstance;
	mhMainWnd = 0;
	mAppPaused = false;
...
HINSTANCE CWindowApp::getAppInst()
{
	return mhAppInst;
}

HWND CWindowApp::getMainWnd()
{
	return mhMainWnd;
}
...
void CWindowApp::updateScene(float dt)
{
	...
	if ((mTimer.getTime() - t_base) >= 1.0f)
	{
		...
		outs << L"FPS: " << fps << L"\n"
			...
			<< "Date and Time: " << std::ctime(&timeDate);
...
LRESULT CWindowApp::msgProc(UINT msg, WPARAM wParam, LPARAM lParam)
{
	switch (msg)
	{
...
void CWindowApp::initMainWindow()
{
	WNDCLASS wc;
